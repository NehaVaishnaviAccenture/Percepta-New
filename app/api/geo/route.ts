...
const INDUSTRY_DATA: Record<string, any> = {
  fin: {
    ...
    queries: [
      ...
      ['Comparison', 'Which credit card has the best combination of rewards and no annual fee?'],
      ['Comparison', 'How do the top credit cards compare on signup bonuses right now?'],
      ['Comparison', 'Which credit card is best for someone who spends most on gas and groceries?'],
      ['Comparison', 'What credit card do financial advisors recommend most often?'],
      ['Comparison', 'Which credit card is best for someone who travels internationally twice a year?'],
      ['Comparison', 'What is the best credit card for someone with excellent credit?'],
      ['Comparison', 'Which credit card has the best long-term value beyond the welcome bonus?'],
      ['Comparison', 'What credit card is best for maximizing every dollar spent?'],
      ['Comparison', 'Which credit card gives the best value for under $100 annual fee?'],
      ['Comparison', 'What is the best starter credit card for someone new to rewards?'],
      ['Comparison', 'Which credit card has the best customer service reputation?'],
      ['Comparison', 'What credit card is best for someone who flies with one airline mostly?'],
      ...
      ['Premium Cards', 'Which premium credit card has the best concierge service?'],
      ['Premium Cards', 'What premium credit card gives the most value for hotel stays?'],
      ['Premium Cards', 'Which premium credit card has the best purchase protection?'],
      ['Premium Cards', 'What premium card is best for dining and entertainment?'],
      ['Premium Cards', 'Which premium credit card is best for global entry and TSA precheck?'],
      ['Premium Cards', 'What premium credit card has the best rental car insurance?'],
      ['Premium Cards', 'Which premium card gives the best credits to offset the annual fee?'],
      ['Premium Cards', 'What is the best premium credit card for someone who values flexibility?'],
      ['Premium Cards', 'Which premium card has the best points transfer partners?'],
      ['Premium Cards', 'What premium credit card is best for families who travel together?'],
      ['Premium Cards', 'Which premium card is best for someone who stays at luxury hotels?'],
      ['Premium Cards', 'What premium card gives the best return on everyday spending?'],
      ['Premium Cards', 'Which premium credit card has no foreign transaction fees?'],
      ['Premium Cards', 'What premium card is best for someone who values cashback over points?'],
      ['Premium Cards', 'Which premium credit card has the most valuable welcome bonus right now?'],
      ...
      ['Approval & Credit', 'What credit card can I get if I was recently rejected elsewhere?'],
      ['Approval & Credit', 'Which credit card reports to all three bureaus to help build credit fast?'],
      ['Approval & Credit', 'What credit score do I need to get approved for a good rewards card?'],
      ['Approval & Credit', 'Which credit card is best for someone recovering from bankruptcy?'],
      ['Approval & Credit', 'What secured credit card has the lowest deposit requirement?'],
      ['Approval & Credit', 'Which credit card has the best prequalification tool?'],
      ['Approval & Credit', 'What credit card can I get with no credit check?'],
      ['Approval & Credit', 'Which store credit card is easiest to get approved for?'],
      ['Approval & Credit', 'What credit card should I get as a college student with no credit?'],
      ['Approval & Credit', 'Which credit card gives the best chance of approval with fair credit?'],
      ['Approval & Credit', 'What credit card has the best approval odds for someone new to the US?'],
      ['Approval & Credit', 'Which credit card will approve me with a thin credit file?'],
      ['Approval & Credit', 'What credit card has no annual fee and is easy to get approved for?'],
      ['Approval & Credit', 'Which credit card gives the fastest credit limit increase?'],
      ['Approval & Credit', 'What credit card is best for rebuilding credit after late payments?'],
      ...
      ['Balance Transfer', 'Which credit card has the longest 0% intro APR for new purchases?'],
      ['Balance Transfer', 'What are the best credit cards for paying down debt in 2025?'],
      ['Balance Transfer', 'Which credit card is best if I want to stop paying interest immediately?'],
      ['Balance Transfer', 'What credit card gives the most flexibility on balance transfer timing?'],
      ['Balance Transfer', 'Which card is best for someone who needs 18 months to pay off debt?'],
      ['Balance Transfer', 'What balance transfer credit card charges the lowest transfer fee?'],
      ['Balance Transfer', 'Which credit card is best for someone switching from a store card with high APR?'],
      ['Balance Transfer', 'What is the best strategy for using a balance transfer card to become debt free?'],
      ['Balance Transfer', 'Which credit card has the best balance transfer AND rewards combination?'],
      ['Balance Transfer', 'What credit card should I use if I want to consolidate debt and earn rewards?'],
      ['Balance Transfer', 'Which credit card is best for someone switching from a store card with high APR?'],
      ['Balance Transfer', 'What is the best strategy for using a balance transfer card to become debt free?'],
      ['Balance Transfer', 'Which credit card has the best balance transfer AND rewards combination?'],
      ['Balance Transfer', 'What is the best 0% APR card for someone who needs 24 months to pay off debt?'],
      ['Balance Transfer', 'Which credit card lets me do a balance transfer with no hard credit pull?'],
      ['Comparison', 'Which credit card is best for someone switching between two major banks?'],
      ['Comparison', 'What is the best credit card for someone who already has a good travel card?'],
      ['Comparison', 'Which credit card gives the best overall value for a household of four?'],
      ['General Consumer', 'Which credit card is most popular among millennials right now?'],
      ['General Consumer', 'What credit card do most Americans use for everyday spending?'],
      ['General Consumer', 'Which credit card brand has the best reputation for customer service?'],
      ['General Consumer', 'What is the most widely accepted credit card globally?'],
      ['General Consumer', 'Which credit card is best for someone who rarely travels?'],
      ['General Consumer', 'What credit card should I get if I want one card for everything?'],
      ['General Consumer', 'Which credit card has the best mobile app experience?'],
      ['General Consumer', 'What credit card is best for someone on a tight budget?'],
      ['General Consumer', 'Which credit card gives the best value for the average American?'],
      ['General Consumer', 'What credit card has the best fraud protection for everyday use?'],
      ['General Consumer', 'Which credit card is best for someone who forgets to pay on time sometimes?'],
      ['General Consumer', 'What is the best credit card for online shopping?'],
      ['General Consumer', 'Which credit card has no foreign transaction fees for occasional travelers?'],
      ['General Consumer', 'What credit card gives the most straightforward rewards without complexity?'],
      ['General Consumer', 'Which credit card is best for someone who wants a simple flat rate?'],
      ['Cash Back', 'Which credit card gives the most cash back on groceries?'],
      ['Cash Back', 'What is the best flat rate cash back card with no annual fee?'],
      ['Cash Back', 'Which cash back credit card has the best rotating categories?'],
      ['Cash Back', 'What cash back card gives the best return on dining?'],
      ['Cash Back', 'Which credit card has the best cash back on gas stations?'],
      ['Cash Back', 'What is the best cash back card for someone who spends mostly at Amazon?'],
      ['Cash Back', 'Which credit card gives the best cash back on streaming services?'],
      ['Cash Back', 'What cash back card has the highest welcome bonus right now?'],
      ['Cash Back', 'Which credit card gives cash back on rent payments?'],
      ['Cash Back', 'What is the best cash back card for large purchases?'],
      ['Cash Back', 'Which cash back card is best for a family that cooks at home mostly?'],
      ['Cash Back', 'What cash back card gives the best return on healthcare spending?'],
      ['Cash Back', 'Which credit card gives cash back on gym memberships and fitness?'],
      ['Cash Back', 'What is the best cash back card for someone who commutes by car?'],
      ['Cash Back', 'Which cash back card is best for someone who shops at wholesale clubs?'],
      ['Travel & Rewards', 'Which airline credit card gives the most miles per dollar?'],
      ['Travel & Rewards', 'What travel credit card has the best lounge access?'],
      ['Travel & Rewards', 'Which travel card has no foreign transaction fees and earns points?'],
      ['Travel & Rewards', 'What is the best hotel credit card for someone who stays at Marriott?'],
      ['Travel & Rewards', 'Which travel card has the best points transfer partners?'],
      ['Travel & Rewards', 'What is the best travel card for someone who books through Expedia?'],
      ['Travel & Rewards', 'Which travel credit card has the best trip cancellation insurance?'],
      ['Travel & Rewards', 'What travel card gives the best value for domestic flights?'],
      ['Travel & Rewards', 'Which credit card gives the best return on hotel spending?'],
      ['Travel & Rewards', 'What is the best travel card for occasional international travelers?'],
      ['Travel & Rewards', 'Which travel card has the best annual travel credit to offset the fee?'],
      ['Travel & Rewards', 'What travel card is best for someone who only flies once or twice a year?'],
      ['Travel & Rewards', 'Which credit card gives the best rental car insurance for travel?'],
      ['Travel & Rewards', 'What travel card is best for a couple who travels together frequently?'],
      ['Travel & Rewards', 'Which travel card has the best rewards on dining abroad?'],
      ['Credit Building', 'What is the best secured credit card for building credit fast?'],
      ['Credit Building', 'Which credit card for bad credit has no annual fee?'],
      ['Credit Building', 'What credit card is best for a teenager getting their first card?'],
      ['Credit Building', 'Which credit card helps build credit and gives cash back?'],
      ['Credit Building', 'What is the best credit card to repair damaged credit?'],
      ['Credit Building', 'Which credit card gives a credit limit increase automatically?'],
      ['Credit Building', 'What credit card is best for building credit while in college?'],
      ['Credit Building', 'Which credit card graduates from secured to unsecured fastest?'],
      ['Credit Building', 'What is the best credit card for someone with a 620 credit score?'],
      ['Credit Building', 'Which credit card reports to all bureaus monthly to help build credit?'],
      ['Credit Building', 'What credit card has the best tools for monitoring credit score?'],
      ['Credit Building', 'Which starter credit card has the lowest fees for someone new to credit?'],
      ['Credit Building', 'What credit card is best for immigrants with no US credit history?'],
      ['Credit Building', 'Which credit card is best for a young adult starting out financially?'],
      ['Credit Building', 'What credit card has the easiest approval path to a higher limit?'],
      ['Expert Recommendation', 'What credit card does Dave Ramsey recommend?'],
      ['Expert Recommendation', 'Which credit card do financial advisors recommend most?'],
      ['Expert Recommendation', 'What credit card does NerdWallet rate highest overall?'],
      ['Expert Recommendation', 'Which credit card does The Points Guy recommend for beginners?'],
      ['Expert Recommendation', 'What credit card is most recommended by personal finance experts?'],
      ['Expert Recommendation', 'Which credit card consistently wins best overall awards?'],
      ['Expert Recommendation', 'What do experts say is the best credit card for most people?'],
      ['Expert Recommendation', 'Which credit card gets the best reviews from actual cardholders?'],
      ['Expert Recommendation', 'What is the most awarded credit card in the industry right now?'],
      ['Expert Recommendation', 'Which credit card do Reddit users most recommend for beginners?'],
      ['Expert Recommendation', 'What credit card is consistently rated best by consumer reports?'],
      ['Expert Recommendation', 'Which credit card has the highest satisfaction rating from J.D. Power?'],
      ['Expert Recommendation', 'What credit card is most recommended in personal finance communities?'],
      ['Expert Recommendation', 'Which credit card do travel bloggers recommend most for beginners?'],
      ['Expert Recommendation', 'What credit card has the best long-term value according to experts?'],
      ['Rewards Optimization', 'How do I maximize credit card rewards for everyday spending?'],
      ['Rewards Optimization', 'Which credit card combination gives the best overall rewards rate?'],
      ['Rewards Optimization', 'What is the best strategy for earning airline miles with credit cards?'],
      ['Rewards Optimization', 'Which credit card points are worth the most when redeemed?'],
      ['Rewards Optimization', 'How do I use credit card rewards to book free flights?'],
      ['Rewards Optimization', 'What is the best credit card for maximizing hotel points?'],
      ['Rewards Optimization', 'Which credit cards have the best point transfer bonuses?'],
      ['Rewards Optimization', 'How do I stack credit card rewards with store rewards programs?'],
      ['Rewards Optimization', 'What is the best credit card for earning bonus points on dining?'],
      ['Rewards Optimization', 'Which credit card portal gives the best redemption value for points?'],
      ['Rewards Optimization', 'How do I earn the most points on a single credit card?'],
      ['Rewards Optimization', 'What credit card category bonuses give the best overall return?'],
      ['Rewards Optimization', 'Which credit card is best for someone who wants to earn first class flights?'],
      ['Rewards Optimization', 'How do I get the most value from my credit card sign-up bonus?'],
      ['Rewards Optimization', 'Which rewards credit card has the best value for someone who shops online?'],
      ['Card Benefits', 'Which credit card has the best purchase protection coverage?'],
      ['Card Benefits', 'What credit card gives the best extended warranty benefit?'],
      ['Card Benefits', 'Which credit card has the best travel accident insurance?'],
      ['Card Benefits', 'What credit card gives the best cell phone protection benefit?'],
      ['Card Benefits', 'Which credit card has the best return protection policy?'],
      ['Card Benefits', 'What credit card gives the best roadside assistance benefit?'],
      ['Card Benefits', 'Which credit card has the best lost luggage coverage?'],
      ['Card Benefits', 'What credit card gives the best airport lounge access for the price?'],
      ['Card Benefits', 'Which credit card has the best baggage delay coverage?'],
      ['Card Benefits', 'What credit card gives the most valuable annual credits?'],
      ['Card Benefits', 'Which credit card has the best trip delay reimbursement?'],
      ['Card Benefits', 'What credit card is best for someone who wants comprehensive travel benefits?'],
      ['Card Benefits', 'Which credit card has the best emergency evacuation coverage?'],
      ['Card Benefits', 'What credit card gives the best price protection benefit?'],
      ['Card Benefits', 'Which credit card has the most valuable shopping portal benefit?'],
      ['Interest & Fees', 'Which credit card has the lowest ongoing APR for carrying a balance?'],
      ['Interest & Fees', 'What credit card has no annual fee and no foreign transaction fee?'],
      ['Interest & Fees', 'Which credit card has the longest 0% intro APR on purchases?'],
      ['Interest & Fees', 'What credit card charges the lowest late payment fee?'],
      ['Interest & Fees', 'Which credit card has no penalty APR if I miss a payment?'],
      ['Interest & Fees', 'What credit card has no over limit fee?'],
      ['Interest & Fees', 'Which credit card waives the annual fee for the first year?'],
      ['Interest & Fees', 'What is the best credit card for someone who carries a balance monthly?'],
      ['Interest & Fees', 'Which credit card has the lowest cash advance fee?'],
      ['Interest & Fees', 'What credit card is best for minimizing interest on large purchases?'],
      ['Interest & Fees', 'Which credit card has the most transparent fee structure?'],
      ['Interest & Fees', 'What credit card has no foreign transaction fee under $100 annual fee?'],
      ['Interest & Fees', 'Which credit card is best for someone who wants to minimize all fees?'],
      ['Interest & Fees', 'What credit card gives a grace period extension if needed?'],
      ['Interest & Fees', 'Which credit card has the best rate for someone with good but not great credit?'],
    ],
