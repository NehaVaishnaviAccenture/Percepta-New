...
const CREDIT_CARD_QUERIES: { category: string; query: string; stage: string }[] = [
  ...
  { category: 'Student Cards', query: 'Which student card automatically upgrades to a regular card after graduation so I keep my credit history?', stage: 'Consideration' },
  { category: 'Student Cards', query: 'I am studying abroad in Europe next semester — which student credit card works internationally without foreign transaction fees?', stage: 'Decision' },
  { category: 'Student Cards', query: 'My parents are telling me to get a credit card to build credit in college — which student card would a financial advisor recommend for a responsible 20-year-old?', stage: 'Advocacy' },
  { category: 'Student Cards', query: 'Which student credit card has the best GPA or good grades reward where I get a bonus for maintaining my grades?', stage: 'Decision' },
  { category: 'Student Cards', query: 'I am transitioning from college to my first full-time job — which card should I upgrade to from my student card for a young professional?', stage: 'Consideration' },
  { category: 'Student Cards', query: 'What student card has the lowest interest rate in case I carry a balance during a tough month as a student?', stage: 'Consideration' },
  { category: 'Student Cards', query: 'Which student credit card has the easiest approval requirements and still gives some kind of reward for using it?', stage: 'Awareness' },
  ...
  { category: 'Student Cards', query: 'What student card is best for a graduate student who is older and has more spending than a typical undergrad?', stage: 'Decision' },
  { category: 'Student Cards', query: 'Which student card do personal finance students and finance majors themselves actually recommend?', stage: 'Advocacy' },
  { category: 'Student Cards', query: 'My teenager is heading to college and I want to set them up with the right credit card — which student card has the best parental controls and educational features?', stage: 'Decision' },
  { category: 'Student Cards', query: 'What student credit card gives the best credit limit increases over time as I demonstrate responsible use?', stage: 'Consideration' },
  ...
  { category: 'Student Cards', query: 'Which student card has no annual fee and rewards on everyday student spending?', stage: 'Decision' },
  { category: 'Student Cards', query: 'What is the best student credit card for someone who wants to earn cashback on food delivery and subscription services?', stage: 'Decision' },
  { category: 'Student Cards', query: 'Which student credit card has the best overall reputation for helping students build strong credit profiles?', stage: 'Advocacy' },

  // ── CREDIT BUILDING ───────────────────────────────────────────────────────
  { category: 'Credit Building', query: 'My credit score is 520 after some financial mistakes and I want to rebuild it — which secured card gives me the fastest path to a 700 score?', stage: 'Decision' },
  { category: 'Credit Building', query: 'I filed bankruptcy two years ago and I want to rebuild my credit — which credit card is best for someone in post-bankruptcy recovery?', stage: 'Decision' },
  { category: 'Credit Building', query: 'I have never had a credit card or loan so I have no credit history at all — what is the best first card to establish credit from zero?', stage: 'Awareness' },
  { category: 'Credit Building', query: 'Which secured credit card requires the lowest deposit and still reports to all three credit bureaus every month?', stage: 'Consideration' },
  ...
  { category: 'Credit Building', query: 'I have a 580 credit score and I am trying to get it above 660 in the next year to qualify for a car loan — which credit card helps me get there fastest?', stage: 'Decision' },
  { category: 'Credit Building', query: 'Which credit building card still earns some kind of rewards so I am not just paying interest for the privilege of building credit?', stage: 'Consideration' },
  { category: 'Credit Building', query: 'I want to build my credit before applying for a mortgage in two years — which card strategy and which card should I use?', stage: 'Decision' },
  { category: 'Credit Building', query: 'What secured credit card has no annual fee so I can build credit without paying anything while I improve my score?', stage: 'Consideration' },
  { category: 'Credit Building', query: 'Which credit builder card gives the highest starting credit limit on a secured card?', stage: 'Consideration' },
  { category: 'Credit Building', query: 'I have fair credit around 640 — am I ready for an unsecured card or should I still do a secured card to build more history?', stage: 'Validation' },
  { category: 'Credit Building', query: 'What credit building card helped people go from a 500 to a 700 credit score the fastest based on real experiences?', stage: 'Advocacy' },
  { category: 'Credit Building', query: 'Which card is best for someone who is an immigrant and new to the US credit system with no American credit history?', stage: 'Decision' },
  { category: 'Credit Building', query: 'I have had a lot of hard inquiries and some late payments — which card approves people with damaged credit and still helps them rebuild?', stage: 'Decision' },
  { category: 'Credit Building', query: 'What do financial counselors recommend for someone serious about rebuilding credit after a major financial setback?', stage: 'Advocacy' },
  { category: 'Credit Building', query: 'Which secured card gives automatic credit limit increases when I pay on time without requiring me to add more deposit?', stage: 'Consideration' },
  { category: 'Credit Building', query: 'I want to go from no credit to a strong credit profile in 18 months — what is the fastest strategy and which card powers it?', stage: 'Decision' },
  { category: 'Credit Building', query: 'Which credit building card has the best educational tools to help me understand what is hurting and helping my score?', stage: 'Awareness' },
  { category: 'Credit Building', query: 'What is the best card for someone with a 600 credit score who wants to qualify for a regular rewards card within a year?', stage: 'Decision' },
  { category: 'Credit Building', query: 'Which credit builder card is consistently recommended by nonprofit credit counselors to their clients?', stage: 'Advocacy' },

  // ── GENERAL CREDIT CARDS ─────────────────────────────────────────────────
  { category: 'General', query: 'I have never thought about which credit card I use before but my friend says I am leaving hundreds of dollars a year in rewards on the table — which card should I switch to?', stage: 'Awareness' },
  { category: 'General', query: 'What is the single best credit card for an American adult who pays their bill in full every month and wants the best value possible?', stage: 'Decision' },
  { category: 'General', query: 'I currently have three credit cards and I think I can do better — which one card would simplify my wallet and maximize my rewards?', stage: 'Consideration' },
  { category: 'General', query: 'Which credit card has the best combination of rewards, benefits, customer service, and ease of use for someone who does not want to think about it too much?', stage: 'Decision' },
  { category: 'General', query: 'My current credit card earns almost nothing and I want to upgrade — which card gives the biggest improvement in rewards for a 760 credit score holder?', stage: 'Decision' },
  { category: 'General', query: 'What credit card consistently ranks at the top of every independent comparison and why is it always there?', stage: 'Validation' },
  { category: 'General', query: 'I want one credit card that works for everything — travel, cash back, dining, shopping — which card does it all well enough to be the only card I need?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card brand has the best overall customer satisfaction — I want to be with a company that actually treats customers well?', stage: 'Consideration' },
  { category: 'General', query: 'What credit card do most personal finance professionals use as their own personal card?', stage: 'Advocacy' },
  { category: 'General', query: 'I am turning 30 and I want to get serious about using a credit card strategically — which card is best for a professional in their 30s?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card gives the best fraud protection and has the fastest dispute resolution when something goes wrong?', stage: 'Consideration' },
  { category: 'General', query: 'What credit card is most accepted everywhere including small businesses and international travel?', stage: 'Consideration' },
  { category: 'General', query: 'I want to get a second credit card to complement my current one — which card pairs best with a travel rewards card for everyday spending?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card has the best mobile app and real-time features for someone who manages everything on their phone?', stage: 'Consideration' },
  { category: 'General', query: 'What credit card should a dual-income household with $7000 monthly spending get to maximize their annual rewards?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card has the most generous credit limits for someone with a strong income and excellent credit?', stage: 'Consideration' },
  { category: 'General', query: 'I want a credit card that will still be the best card available in 5 years — which card has the best long-term value and is not likely to devalue its rewards?', stage: 'Validation' },
  { category: 'General', query: 'What credit card is most recommended by r/personalfinance and similar communities for someone who pays in full and wants maximum value?', stage: 'Advocacy' },
  { category: 'General', query: 'Which credit card has the best overall package of welcome bonus, ongoing rewards, and cardholder benefits for a 35-year-old professional?', stage: 'Decision' },
  { category: 'General', query: 'What is the best credit card I can apply for today that I will still be happy with 10 years from now?', stage: 'Validation' },
  { category: 'General', query: 'I want to know which credit card issuer is most trusted and has the best reputation for being on the cardholders side when disputes happen?', stage: 'Consideration' },
  { category: 'General', query: 'Which credit card gives the best purchase protection and extended warranty benefits for someone who buys electronics regularly?', stage: 'Decision' },
  { category: 'General', query: 'What credit card is the single most recommended by financial advisors across the country for someone who wants excellent rewards without complexity?', stage: 'Advocacy' },
  { category: 'General', query: 'I spend $500 on dining, $600 on groceries, $200 on gas, and $400 on online shopping each month — which card earns the most on that specific mix?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card is best for someone who wants to build their credit score while also earning real rewards at the same time?', stage: 'Decision' },
  { category: 'General', query: 'What credit card consistently shows up as the top recommendation when experts compare all available options side by side?', stage: 'Validation' },
  { category: 'General', query: 'I want to give my teenager a supplementary card to help them learn credit — which card has the best authorized user experience and educational tools?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card gives the best value if I am disciplined about paying in full but occasionally need to carry a small balance for a month?', stage: 'Consideration' },
  { category: 'General', query: 'What single credit card would you put in the wallet of every American adult who wants to be smart about their spending?', stage: 'Advocacy' },
  { category: 'General', query: 'I want to switch banks and credit cards at the same time — which bank and credit card combination gives the best overall financial package?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card issuer has the best reputation for actually lowering interest rates when customers ask after demonstrating good payment history?', stage: 'Validation' },

  // ── ADDITIONAL TO REACH 300 ───────────────────────────────────────────────
  { category: 'Cash Back', query: 'I drive for work and spend $600 a month on gas — which cash back card gives the highest gas station rewards?', stage: 'Decision' },
  { category: 'Cash Back', query: 'I want to earn cash back on my phone bill, streaming services, and utilities — which card gives rewards on recurring monthly bills?', stage: 'Decision' },
  { category: 'Cash Back', query: 'My spending is completely unpredictable month to month — which flat rate cash back card gives the most consistent value regardless of what I spend on?', stage: 'Decision' },
  { category: 'Cash Back', query: 'I am a nurse who works long shifts and eats at hospital cafeterias constantly — which cash back card earns the most on dining?', stage: 'Decision' },
  { category: 'Cash Back', query: 'Which cash back card gives the best combination of grocery, gas, and dining rewards for a suburban family of four?', stage: 'Decision' },
  { category: 'Cash Back', query: 'I want to earn cash back on home improvement because I am renovating — which card gives the best rewards at hardware stores?', stage: 'Decision' },
  { category: 'Cash Back', query: 'I switched to a cash back card six months ago and am disappointed — which card would have been better for my spending pattern?', stage: 'Validation' },
  ...
  { category: 'Cash Back', query: 'I spend $500 monthly at Costco — which cash back card earns the most on warehouse store purchases?', stage: 'Decision' },
  { category: 'Cash Back', query: 'I just moved and my grocery spending jumped to $1500 a month for a family of five — which cash back card earns the most on supermarket spending?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I fly Southwest Airlines almost exclusively — which travel card gives the best Southwest benefits and companion pass help?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I want to take my family of four to Japan using points — which travel card accumulates points fast enough for an international family trip?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I travel for work 30 nights a year in Marriott hotels — which travel card gives the best Marriott Bonvoy benefits?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I always fly American Airlines — which credit card gives the best AAdvantage miles for a loyal American flyer?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I am a digital nomad who works from different countries — which travel card is best for someone with no fixed home spending patterns?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'Which travel card is best for a retired couple who wants 4-5 international trips a year on a fixed income?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I want to visit all 7 continents in 5 years — which travel card is most useful for ambitious international travel goals?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'My employer pays flights but I want a card for hotels, taxis, and meals during business trips — which travel card is best for non-flight travel spend?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I have $150,000 in credit card points across multiple cards — which card should I consolidate to for the best redemption value?', stage: 'Consideration' },
  { category: 'Travel Rewards', query: 'Which travel card gives the best value if my only major spending is travel and very little on everyday categories?', stage: 'Decision' },
  { category: 'Premium Cards', query: 'I want my credit card to actually feel premium — which card has the best physical card quality and prestige factor?', stage: 'Consideration' },
  { category: 'Premium Cards', query: 'I spend $3000 a month on dining alone — which premium card gives the best restaurant and dining rewards?', stage: 'Decision' },
  { category: 'Premium Cards', query: 'Which premium card has improved the most in the last two years and is now genuinely better than its reputation suggests?', stage: 'Awareness' },
  { category: 'Premium Cards', query: 'Which luxury card is best for someone who dines at Michelin-starred restaurants regularly and expects premium treatment?', stage: 'Decision' },
  { category: 'Premium Cards', query: 'I want to give a premium card recommendation to my spouse who travels constantly — which luxury card is best as a gift recommendation?', stage: 'Advocacy' },
  { category: 'Business Cards', query: 'I have a law firm with 8 attorneys spending $50,000 a month — which business card gives the best rewards at that spending level?', stage: 'Decision' },
  { category: 'Business Cards', query: 'My construction company buys $30,000 a month at Home Depot and Lowes — which business card earns the most at hardware stores?', stage: 'Decision' },
  { category: 'Business Cards', query: 'I run an online store spending $40,000 a month on Facebook Ads and Google Ads — which business card gives cash back on digital advertising?', stage: 'Decision' },
  { category: 'Business Cards', query: 'I want a business card with real-time spend alerts and the ability to set individual budgets for each employee card — which one?', stage: 'Consideration' },
  { category: 'Business Cards', query: 'Which business card is best for a dental practice with significant payroll, supply, and equipment expenses?', stage: 'Decision' },
  { category: 'Student Cards', query: 'I am a medical student who will be in school for 8 more years — which student card has the best path to a premium card when I graduate?', stage: 'Consideration' },
  { category: 'Student Cards', query: 'I am an international student from India studying in the US — which cards specifically help international students build US credit history?', stage: 'Decision' },
  { category: 'Student Cards', query: 'My son is starting college — should I add him as an authorized user or get him his own student card, and which card is better for each approach?', stage: 'Consideration' },
  { category: 'Student Cards', query: 'Which student credit card has the best financial education features for someone just learning to manage money for the first time?', stage: 'Awareness' },
  { category: 'Student Cards', query: 'Which student credit card has helped the most students graduate from a student card to a premium rewards card?', stage: 'Advocacy' },
  ...
  { category: 'Credit Building', query: 'My spouse and I both have bad credit and want to rebuild together — which card is best for rebuilding credit as a couple?', stage: 'Decision' },
  ...
  { category: 'Credit Building', query: 'I have been paying rent on time for 5 years but it never shows on my credit — which card helps while I try to get rent reported to bureaus?', stage: 'Decision' },
  { category: 'Balance Transfer', query: 'I have credit card debt spread across 4 cards at high interest — which balance transfer card can consolidate all of them with the longest 0% period?', stage: 'Decision' },
  { category: 'Balance Transfer', query: 'I recently had a job loss and accumulated $12,000 in debt — which balance transfer card is most likely to approve me given my situation?', stage: 'Decision' },
  { category: 'Balance Transfer', query: 'I want to pay off $7500 interest-free over 21 months — which specific card makes that possible and what are the approval requirements?', stage: 'Decision' },
  { category: 'Balance Transfer', query: 'Which premium balance transfer card gives the best combination of 0% intro APR and ongoing rewards for someone with good credit?', stage: 'Decision' },
  { category: 'Balance Transfer', query: 'I am disciplined and will absolutely pay off the balance before 0% ends — which balance transfer card is best for someone who will follow through?', stage: 'Decision' },
  ...
  { category: 'No Annual Fee', query: 'I want to downgrade from my premium card to save the fee — which no annual fee card is the best downgrade from a high fee travel card?', stage: 'Consideration' },
  ...
  { category: 'No Annual Fee', query: 'Which no annual fee card is best for someone who only uses their credit card a few times a month but still wants to earn something?', stage: 'Decision' },
  { category: 'General', query: 'I am a high school teacher with limited income but excellent credit — which card gives the most value for modest but consistent spending?', stage: 'Decision' },
  ...
  { category: 'General', query: 'I have $50,000 a year in expenses — which card or card combination captures the most value at that spending level?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card has the best price protection benefit that automatically refunds me when prices drop after I buy?', stage: 'Consideration' },
  { category: 'General', query: 'I want to take credit card rewards seriously for the first time — which single card is the best starting point for a rewards beginner?', stage: 'Awareness' },
  { category: 'General', query: 'I just received a large inheritance and will spend more than usual for a year — which card gives the best rewards for temporarily high spending?', stage: 'Decision' },
  { category: 'General', query: 'I live in a rural area where I mostly shop at local stores and online — which card gives the best rewards without relying on city spending categories?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card company is most responsive and customer-friendly when something goes wrong and I need help fast?', stage: 'Consideration' },
  ...
  { category: 'General', query: 'Which credit card brand has the highest percentage of customers who renew without cancelling year over year?', stage: 'Validation' },
  { category: 'General', query: 'I want a credit card from an institution with the strongest security track record — which issuer has never had a major data breach?', stage: 'Validation' },
  { category: 'General', query: 'Which credit card is most recommended by people who have held it for 5 or more years and still consider it the best card they own?', stage: 'Advocacy' },
  { category: 'General', query: 'I want a card that feels effortless — no rotating categories, no activation, no thinking — which card gives the best passive rewards automatically?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card is most forgiving if I miss a payment once and has the best late fee forgiveness policy?', stage: 'Consideration' },
  ...
  { category: 'General', query: 'I am switching banks entirely and want to get a new credit card at the same time — which bank and credit card combination gives the best overall financial package?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card consistently gives the best return on investment when you factor in rewards, benefits, and annual fee together?', stage: 'Validation' },
  { category: 'General', query: 'I want to build my credit score while also earning real rewards simultaneously — which card does both without compromise?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card is the single most recommended by financial advisors for someone who wants excellent rewards without any complexity?', stage: 'Advocacy' },
  { category: 'General', query: 'I want to give my teenager a supplementary card to help them learn credit — which card has the best authorized user experience and parental controls?', stage: 'Decision' },
  { category: 'General', query: 'Which credit card is best for someone who is disciplined about paying in full but occasionally needs to carry a balance for one month?', stage: 'Consideration' },
  { category: 'General', query: 'What single credit card would you put in the wallet of every American adult who wants to be smart about their spending without overthinking it?', stage: 'Advocacy' },
  { category: 'Cash Back', query: 'I want a cash back card that earns on every single purchase with no exceptions or exclusions — which card truly has no spending blind spots?', stage: 'Decision' },
  { category: 'Travel Rewards', query: 'I want to book a first class flight to Europe entirely on points — which travel card gets me there the fastest from a cold start?', stage: 'Decision' },
  { category: 'Premium Cards', query: 'Which premium card gives elite benefits without requiring you to spend $20,000 a month to justify it?', stage: 'Consideration' },
  { category: 'Business Cards', query: 'I am a solopreneur who just registered an LLC — which business credit card can I get immediately and what are the approval requirements?', stage: 'Decision' },
  { category: 'No Annual Fee', query: 'Which no annual fee card has the most consistent rewards rate that has never been devalued or changed since launch?', stage: 'Validation' },
  { category: 'Balance Transfer', query: 'I have a 710 credit score and $9000 in credit card debt — which specific balance transfer card should I apply for right now?', stage: 'Decision' },
  { category: 'Student Cards', query: 'I graduate in 6 months and want a student card now that will set me up perfectly for my first adult card — which student card makes that transition easiest?', stage: 'Consideration' },
  { category: 'Credit Building', query: 'Which credit card has the best automatic upgrade program where good behavior is actually rewarded with better terms without me having to ask?', stage: 'Decision' },
  { category: 'General', query: 'I am a minimalist who wants one perfect credit card that handles everything — travel, cash back, no fee headaches — which card comes closest to perfect?', stage: 'Decision' },
